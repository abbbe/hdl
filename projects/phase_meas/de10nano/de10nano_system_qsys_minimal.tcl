...
# Minimal DE10-Nano base system for phase measurement project
# Excludes HDMI and video DMA to save FPGA resources
...
set_instance_parameter_value sys_gpio_bd {width} {8}
